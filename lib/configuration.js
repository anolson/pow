(function() {
  ...
  module.exports = Configuration = (function() {
    ...
    function Configuration(options) {
      var domain, _ref, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (options == null) {
        options = {};
      }
      ...
      this.loggers = {};
      this.pow_info_host = (_ref23 = (_ref24 = options.pow_info_host) != null ? _ref24 : process.env['POW_INFO_HOST']) != null ? _ref23 : "show.pow";
    }
    Configuration.prototype.getPowInfoHostPattern = function() {
      return RegExp("^(" + this.pow_info_host + ")($|\\.)");
    };
    ...
    Configuration.prototype.findApplicationRootForHost = function(host, callback) {
      return this.gatherApplicationRoots(__bind(function(err, roots) {
        ...
        if (root = roots["default"]) {
          return callback(null, this.domains[0], root);
        }
        return callback(null);
      }, this));
    };
